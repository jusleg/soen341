...
(function () {
    ...
    angular.module('app', ['ui.bootstrap', 'ngRoute', 'app.header', 'app.classroom', 'app.createclass', 'app.homepage']).config(['$locationProvider', '$routeProvider', '$httpProvider', function ($locationProvider, $routeProvider, $httpProvider) {
